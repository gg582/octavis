...
export const translations = {
  en: {
    ...
    dec_method1_hint: 'Upload your .png image or .webm video stream to decode instantly via WASM.',
    dec_divider: 'OR',
    ...
    dec_recovered_label: 'Decoded Payload Result',
    btn_download_file: 'Download Recovered File',
    btn_wipe_mem: 'Wipe Memory (Zeroize)',

    // OctaZip Tab
    zip_enc_title: 'OctaZip Package Encoder',
    zip_enc_hint: 'Directly converts any input file/text into a compact .octazip archive with ChaCha20 encryption and Brotli compression.',
    ...
    zip_dec_hint: 'Upload your .octazip archive to unpack and recover the original file via WASM.',
    zip_btn_decode: 'Decode .octazip & Restore',
  },
  ko: {
    title: 'OctaVis & OctaZip (v1.1)',
    ...
    btn_encode: '변환 및 다운로드',
    
    // OctaVis Decoder
    dec_title: 'OctaVis 디코더',
    dec_method1_label: '광학 미디어 파일 업로드 (.png / .webm)',
    dec_method1_hint: '생성된 .png 이미지나 .webm 영상을 올리면 WASM이 즉시 원본 파일로 복구합니다.',
    dec_divider: '또는',
    ...
    dec_recovered_label: '복원된 원본 데이터',
    ...
    zip_dec_hint: '수신한 *.octazip 파일을 올리면 WASM이 압축과 암호를 해제하여 원본 파일로 복구합니다.',
    zip_btn_decode: '.octazip 복구 및 다운로드',
  },
  zh: {
    title: 'OctaVis & OctaZip (v1.1)',
    ...
    zip_dec_hint: '上传 *.octazip 归档文件，WASM 将解压并解密还原出原始文件。',
    zip_btn_decode: '解码 .octazip 并还原',
  }
};
